...
- Block builders end every block with `\n`; the coordinator strips the last one so TextKit 2 shows no trailing empty line, and restores it on append. See `apple-pitfalls.md` ("TextKit 2 leaves a blank row").
